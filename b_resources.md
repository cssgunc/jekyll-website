...
<h2 id="content">Online Resources</h2>
	<h3>Tools for...</h3>
		<ul class="actions">
			...
			<li><a href="#" class="button">Programming</a></li>
			<li><a href="#" class="button">Databases</a></li>
			<li><a href="#" class="button">Building a Website</a></li>
			<li><a href="#" class="button">Data Analysis</a></li>
			<li><a href="#" class="button">Security</a></li>
